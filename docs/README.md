...
* [API](/docs/API.md)
  ...
  * [GYARADOS_VERSION](/docs/API.md#spaceshipversion)
  * [__gyarados_lib_section](/docs/API.md#__gyarados_lib_section-color-prefix-content-suffix)
  * [__gyarados_util_set_default](/docs/API.md#__gyarados_util_set_default-variable_name-value)
  * [__gyarados_util_git_branch](/docs/API.md#__gyarados_util_git_branch)
