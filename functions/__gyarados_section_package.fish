...
function __gyarados_section_package -d "Display the local package version"
	# ------------------------------------------------------------------------------
	# Configuration
	# ------------------------------------------------------------------------------

	__gyarados_util_set_default GYARADOS_PACKAGE_SHOW true
	__gyarados_util_set_default GYARADOS_PACKAGE_PREFIX "is "
	__gyarados_util_set_default GYARADOS_PACKAGE_SUFFIX $GYARADOS_PROMPT_DEFAULT_SUFFIX
	__gyarados_util_set_default GYARADOS_PACKAGE_SYMBOL "📦 "
	__gyarados_util_set_default GYARADOS_PACKAGE_COLOR red

	# ------------------------------------------------------------------------------
	# Section
	# ------------------------------------------------------------------------------

	[ $GYARADOS_PACKAGE_SHOW = false ]; and return
	...
	__gyarados_lib_section \
		$GYARADOS_PACKAGE_COLOR \
		$GYARADOS_PACKAGE_PREFIX \
		"$GYARADOS_PACKAGE_SYMBOL$package_version" \
		$GYARADOS_PACKAGE_SUFFIX
end
